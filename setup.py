...
https://github.com/chdemko/pandoc-latex-margin
"""
...
setup(
    ...
    url="https://github.com/chdemko/pandoc-latex-margin",
    # The project's download page
    download_url="https://github.com/chdemko/pandoc-latex-margin/archive/develop.zip",
    # Author details
    ...
    keywords="pandoc filters latex margin",
    # Alternatively, if you want to distribute just a my_module.py, uncomment
    # this:
    py_modules=["pandoc_latex_margin"],
